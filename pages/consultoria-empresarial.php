<section class="page-hero">
  <div class="container">
    <div class="page-hero-content reveal">
      ...
      <h1 class="page-title">Estratégia que <span class="gradient-text">transforma</span> negócios</h1>
      <p class="page-subtitle">Desde 2019 impulsionando empresas com soluções inteligentes e gestão de excelência.</p>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="service-intro reveal">
      <div class="service-intro-content">
        <h2>Consultoria que vai além do básico</h2>
        <p>A <strong>Control Consultoria</strong> oferece consultoria empresarial de alto nível para empresas que buscam mais que resultados, buscam transformação. Atuamos com profundo envolvimento em cada projeto, oferecendo soluções personalizadas para cada cliente.</p>
...
<section class="service-process section">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h2 class="section-title">Como <span class="gradient-text">trabalhamos</span></h2>
      <p class="section-text">Um processo estruturado em 4 etapas para garantir resultados reais.</p>
    </div>
...
<section class="section">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h2 class="section-title">Por que escolher a <span class="gradient-text">Control</span>?</h2>
    </div>
...
<section class="cta-section section">
  <div class="container">
    <div class="cta-card reveal">
      ...
      <h2 class="cta-title">Pronto para <span class="gradient-text">transformar</span> sua empresa?</h2>
      <p class="cta-text">Agende uma conversa sem compromisso e descubra como podemos impulsionar seu negócio.</p>
