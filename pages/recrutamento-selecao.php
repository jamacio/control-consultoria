<section class="page-hero">
  <div class="container">
    <div class="page-hero-content reveal">
      <span class="hero-badge">Recrutamento & Seleção</span>
      <h1 class="page-title">O talento certo para o <span class="gradient-text">seu negócio</span></h1>
      <p class="page-subtitle">Processos seletivos inteligentes que conectam sua empresa aos melhores profissionais do mercado.</p>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="service-intro reveal">
      <div class="service-intro-content">
        <h2>Encontre os profissionais que sua empresa merece</h2>
        <p>O sucesso de uma empresa começa com as pessoas certas. Na <strong>Control Consultoria</strong>, realizamos processos de <strong>recrutamento e seleção</strong> completos, desde a triagem curricular até a contratação, garantindo o <strong>fit cultural e técnico</strong> ideal para sua organização.</p>
...
<section class="service-process section">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h2 class="section-title">Como funciona nosso <span class="gradient-text">recrutamento</span></h2>
      <p class="section-text">Da abertura da vaga à contratação, cuidamos de cada etapa com excelência.</p>
    </div>
...
<section class="section">
  <div class="container">
    <div class="section-header reveal">
      ...
      <h2 class="section-title">Vantagens do nosso <span class="gradient-text">processo seletivo</span></h2>
    </div>
...
<section class="cta-section section">
  <div class="container">
    <div class="cta-card reveal">
      ...
      <h2 class="cta-title">Tem uma vaga para <span class="gradient-text">preencher</span>?</h2>
      <p class="cta-text">Entre em contato e descubra como podemos encontrar o profissional ideal para sua empresa.</p>
